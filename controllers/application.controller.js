...
// //     const fcmData = await Fcm.findOne({ userId });
...
// console.log("application * limit=", application.length);
// if (totalApplications === application?.length) {
//   hasMore = false;
// } else {
//   hasMore = true;
// }
...
export const getAppliedJobs = async (req, res) => {
  console.log("GET APPLIED JOBS AMIGO", req.query);
